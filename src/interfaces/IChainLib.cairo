...
use crate::chainlib::ChainLib::ChainLib::{
    Category, Subscription, Payment, ContentType, ContentMetadata, DelegationInfo, SalesMetrics,
    PurchaseAnalytics, ConversionMetrics, Receipt, ReceiptStatus, TimeBasedMetrics, CreatorMetrics,
};
...
pub trait IChainLib<TContractState> {
    ...
    fn get_total_sales_by_creator(
        ref self: TContractState, creator: ContractAddress,
    ) -> CreatorMetrics;
    ...
    // Purchase Analytics
    fn get_purchase_analytics(ref self: TContractState, content_id: felt252) -> PurchaseAnalytics;
    ...
    // Receipt Generation
    fn generate_receipt(
        ref self: TContractState, purchase_id: u256,
    ...
    fn get_user_receipts(ref self: TContractState, user: ContractAddress) -> Array<Receipt>;
    ...
    fn get_receipt_analytics(
        ref self: TContractState,
    ) -> (u256, u256, u256); // (total, valid, invalid)
